...
Many-to-Many relationships between objects are added by adding a new object that has a one-to-many relationship with each object participating in the many-to-many relation. Please review [One-to-many relationship](../objects/index.html#one-to-many-relationship) before continuing with this section.
